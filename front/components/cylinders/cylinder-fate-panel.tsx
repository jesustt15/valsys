...
import { decideCylinderFateAction, type CylinderFormState } from '@/lib/actions/cylinder'
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor={`status-${cylinder.id}`} required>Destino del Cilindro</Label>
                    <select
                    ...
                    >
                      <Alert className="border-green-200 bg-green-50 dark:bg-green-900/20 dark:border-green-800">
                        ...
                        <AlertDescription className="text-green-700 dark:text-green-400">
                          Destino del cilindro registrado correctamente.
                        </AlertDescription>
                      </Alert>
                    </motion.div>
                  )}
...
export function CylinderFatePanel({ inspectionId, cylinders }: Props) {
        ...
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Destino de Cilindros
            </CardTitle>
            <CardDescription>
              {isComplete
                ? 'Todos los cilindros han sido resueltos'
                : `Definí el destino de cada cilindro: recertificar o dar de baja`
              }
            </CardDescription>
          </div>
