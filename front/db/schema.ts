...
export const vehicles = pgTable('vehicles', {
  ...
  vinSerial: varchar('vin_serial').notNull(),
  codigoUnicoGnc: varchar('codigo_unico_gnc').unique(),
  ...
  codigoUnicoGncIdx: index('idx_vehicles_codigo_unico_gnc').on(table.codigoUnicoGnc),
